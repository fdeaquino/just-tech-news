...
// GET /api/users, then select all users from the user table in the database and send it back as JSON
router.get('/', (req, res) => {
...
router.post('/', (req, res) => {
    ...
    User.create({
        ...
        // allows us to access the session information in the route
        .then(dbUserData => {
            req.session.save(() => {
